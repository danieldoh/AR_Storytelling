...
def run_mdm(model, action_name):
    ...
    working_directory = "/workspace/animation_from_TP/priorMDM/"
    print("Action: \"{}\" is processing...".format(action_name))
    #subprocess.run([f"python -m sample.generate --model_path ./save/humanml_trans_enc_512/model000200000.pt --input_text /workspace/animation_from_TP/mdm.txt --output_dir /workspace/animation_from_TP/pose_video/{output_path} --video_name {action_name}"], shell=True, cwd=working_directory)
